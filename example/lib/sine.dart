...
int main(List<String> arguments) {
  final parser = ArgParser()
    ...
    ..addOption('format',
        defaultsTo: 'i16', allowed: ['i16', 'i24', 'i32', 'f32', 'f64']);
  ...
  if (samplerate < 100 || samplerate > 100000) {
    print(
        "invalid samplerate. should be a positive number larger than 100 and lower than 100,000");
    return -1;
  }
